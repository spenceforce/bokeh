...
.. warning::
    The class :class:`~bokeh.core.properties.AnyVal` is the super-type of all
    other types and will accept any type of value. Since this circumvents all
    type validation, make sure to use it sparingly, if at all.
